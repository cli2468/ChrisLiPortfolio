...
function AsciiDonut() {
  ...
  return (
    ...
    >
      ...
      <span className={`ascii-donut__hint${showHint ? '' : ' ascii-donut__hint--hidden'}`}>
  ...
  return (
    <section id="work" className="work-scroll work-scroll--mobile">
      <div className="work-carousel">
        ...
        <AnimatedText text={activeProject.title} className="work-carousel__title" tag="h3" />
        <AnimatedText text={activeProject.category} className="work-carousel__category" tag="p" />
        <AnimatedText text={activeProject.desc} className="work-carousel__desc" tag="p" />
    ...
    <section id="contact" className="contact">
      ...
      <Reveal delay={300}>
        <div className="contact__socials">
          <a href="https://www.linkedin.com/in/chrisjoshli/" target="_blank" rel="noopener noreferrer" className="contact__social-link">LinkedIn</a>
        </div>
      </Reveal>
    </section>
  )
